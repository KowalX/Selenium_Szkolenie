...
package SeleniumWorkshop.patch.org.easetech.easytest.runner;
...
import SeleniumWorkshop.patch.org.easetech.easytest.loader.DataLoaderUtil;
 ...
 * annotation.<br>
 * (For details on how he test bean is loaded look at {@link org.easetech.easytest.runner.TestConfigUtil#loadTestBeanConfig(Class)}) method.</li>
 ...
 * level. Look at {@link org.easetech.easytest.runner.TestConfigUtil#loadResourceProperties(Class, Object)} method for details.</li>
...
public class DataDrivenTestRunner extends BlockJUnit4ClassRunner {
     ...
     * allow the user to override the default name, {@link FrameworkMethod} is extended with {@link org.easetech.easytest.runner.EasyFrameworkMethod}
     * and {@link org.easetech.easytest.runner.EasyFrameworkMethod#setName(String)} method introduced.
     *
